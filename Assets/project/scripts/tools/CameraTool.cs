...
{
    [SerializeField] private int recoverEnergyOnRemovedTarget;
    ...
    {
        if (against.health <= against.stackedDamage) Main.obj.workplace.energyBar.Change(recoverEnergyOnRemovedTarget);
    }
}
